...
json_config_path = os.path.join(parent_dir, "configs", "archon-SOTA-modelsx8_1_samples_2_layers_with_unit_tests_then_critic_then_rank_top5_then_critic_then_fuser.json")
print("LOG: Loading Archon configuration from", json_config_path)
with open(json_config_path, 'r') as f:
    config = json.load(f)

@register_model("archon_together_4")
class Archon_Together_4(APIModelBase):
