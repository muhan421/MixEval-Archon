...
@register_model("llama_31_405b_instruct_together")
class Llama_3_70B_Instruct_Together(APIModelBase):
    def __init__(self, args):
        super().__init__(args)
        self.args = args
        self.client = Together(api_key=os.environ.get("TOGETHER_API_KEY"))
        self.async_client = AsyncTogether(api_key=os.environ.get("TOGETHER_API_KEY"))
        self.model_name = "meta-llama/Meta-Llama-3.1-405B-Instruct-Turbo"
